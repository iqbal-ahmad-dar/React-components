  ...
  return (
    <>
      <div className="mb-2.5">
        {label && (
          <div className={labelClassName || style.attachmentLabel}>{label}</div>
        )}
          ...
          <div>
            {selectedFiles.map((file, index) => (
              <div
                ...
                className={
                  fileItemClassName ||
                  'mt-[5px] flex items-center justify-between border border-solid border-[#eee] bg-light max-w-[500px]'
                }
              >
                ...
                <div
                  ...
                  className={
                    removeButtonClassName ||
                    'flex h-[28px] w-[28px] cursor-pointer items-center justify-center bg-danger text-white'
                  }
